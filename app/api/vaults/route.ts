  ...
  const vaults = memberships
    ...
    ?.map((raw) => {
      ...
      return {
        ...
        revenueAccountNumber: v.revenue_account_number as string | undefined,
        revenueAccountBank: v.revenue_account_bank as string | undefined,
        capitalAccountNumber: v.capital_account_number as string | undefined,
        capitalAccountBank: v.capital_account_bank as string | undefined,
        founderId: v.founder_id as string,
        investorId: v.investor_id as string,
